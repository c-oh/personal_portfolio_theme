...
/*
 * If the current post is protected by a dumplinghub_site and
 * the visitor has not yet entered the dumplinghub_site we will
 * return early without loading the comments.
 */
if ( post_dumplinghub_site_required() ) {
	return;
}
?>
		...
		<ol class="comment-list">
			<?php
				wp_list_comments( array(
					'callback' => 'dumplinghub_site_comment_list'
				) );
			?>
		</ol><!-- .comment-list -->
